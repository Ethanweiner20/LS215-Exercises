...
/*
By default, `sort` compares the string representations of the elements of the
caller array. In this instance, we want `sort` to compare the elements in the
array as numbers, so we must provide a custom callback to `sort`. `median`
can not compute properly without properly sorted elements.
*/
